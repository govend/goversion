// Package linkheader implements parsing and serialization of Link header values as
// defined in RFC 5988.
//
// This code is from https://github.com/tent/http-link-go.
package linkheader
...
// Link represents a parsed link from an HTTP Header.
type Link struct {
	URI    string
	Rel    string
